...
import org.project.repository.DoctorAppointmentsRepositoryBinaryFile;
import org.project.repository.DoctorAppointmentsRepositoryTextFile;
import org.project.repository.DoctorRepositoryBinaryFile;
import org.project.repository.PatientRepositoryBinaryFile;
import org.project.repository.PatientRepositoryTextFile;
import org.project.repository.DoctorRepositoryTextFile;
import org.project.repository.IRepository;
import org.project.repository.MemoryRepository;
...
public class Services {
    ...
    public Services() {
        ...
        String settingsName = "Project/src/settings.properties";
...
//        else if (repositoryType != null && repositoryType.equals("database")) {
...
//        }
    ...
    public void addAppointment(Integer id, Integer doctorId, Integer patienId, String specialization, String appointedTime) {
        DoctorAppointments newAppointment = new DoctorAppointments(id, doctorId, patienId, specialization, appointedTime);
    ...
    public void updateAppointment(Integer id, Integer doctorId, Integer patientId, String specialization, String appointedTime) {
        DoctorAppointments newAppointment = new DoctorAppointments(id, doctorId, patientId, specialization, appointedTime);
